...
Open file:///Users/YOUR-NAME/repos/{repo-name}/build/site/index.html in a browser to view your site.
----
+
...
To learn how to publish documentation to {url-datastax-docs}, see the https://github.com/riptano/datastax-docs-site#deploy-production[datastax-docs-site README].
