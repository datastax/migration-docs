...
* *`MIGRATION_DIR`*: The entire `uploadBucketDir` value that was generated when you xref:sideloader:sideloader-overview.adoc#initalize-migration[initialized the migration], including the trailing slash.
