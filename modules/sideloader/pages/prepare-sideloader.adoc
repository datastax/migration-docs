...
After the initial migration, you can use another strategy to move the encrypted data, such as {cass-migrator-repo}[{cass-short} Data Migrator (CDM)] or a manual export and reupload.
