...
However, {company} neither tests all data store providers nor guarantees support for any specific data source aside from the sources and versions listed here.
