...
* Contact https://support.datastax.com/[{company} Support] for help configuring your workload.
====
...
* For {astra-db}, you will need to ensure outbound connectivity to the {astra-db} endpoint indicated in the Secure Connect Bundle.
