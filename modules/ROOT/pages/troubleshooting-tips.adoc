...
Protocol version downgrades results from a request by a cluster that doesn't support the version that the client requested.
{product-proxy} supports `V3`, `V4`, `V5`, `DSE_V1` and `DSE_V2`.
...
* {dsbulk-loader-repo}/issues[{dsbulk-loader} repository]
