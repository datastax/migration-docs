...
.Configuration file change in {product-automation} version 2.2.0
[IMPORTANT]
====
...
+
--
** **Both `{asterisk}_astra_db_id` and `{asterisk}_astra_token`**: If you want {product-automation} to automatically download your database's {scb}, use `*_astra_db_id` and `*_astra_token`.
