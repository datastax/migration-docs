...
{cass-migrator-short} is best for large or complex migrations that benefit from advanced features and configuration options, such as the following:
...
== {cass-migrator-short} last-write-wins with {product-proxy}
