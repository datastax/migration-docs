...
* xref:mission-control:migrate:nosql-to-mission-control.adoc[Migrate {hcd-short},{dse-short}, and other {cass-short}-based clusters to {mc} using the add a new datacenter method]
* xref:mission-control:migrate:oss-cass-to-mission-control.adoc[Migrate {cass-short} clusters to {mc} using the add a new cluster method]
