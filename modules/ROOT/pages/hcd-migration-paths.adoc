...
For information about installing and configuring {hcd-short}, see the xref:1.1@hcd:get-started:get-started-hcd.adoc[{hcd-short} documentation].
...
//* xref:1.2@hcd:migrate:dse-68-to-hcd-12.adoc[In-place upgrade from {dse-short} 6.8 to {hcd-short} 1.2.3]
//* xref:1.1@hcd:migrate:dse-51-to-hcd-11.adoc[In-place upgrade from {dse-short} 5.1 to {hcd-short} 1.1]