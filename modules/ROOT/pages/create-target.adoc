...
This role will be used by the client application, the {product-proxy}, and the {zdm-automation}.
...
* {cstar-data-migrator} or DSBulk Migrator, to migrate and validate data into Astra DB.
