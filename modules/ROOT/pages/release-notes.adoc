...
The ZDM 2.1.0 release adds {product-proxy} heartbeat functionality and provides several bug fixes.
...
* https://github.com/datastax/zdm-proxy-automation[{zdm-automation}] repo for Ansible-based {product-proxy} automation.

* https://github.com/datastax/dsbulk-migrator[DSBulk Migrator] repo for migration of smaller data quantities.

* https://github.com/datastax/cassandra-data-migrator[{cstar-data-migrator}] repo for migration of larger data quantities and where detailed verifications and reconciliation options are needed.
