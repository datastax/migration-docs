...
//TODO: Find out the latest release of ZDM. Decide if the release notes should point to github instead.
//TODO: Add release notes/change log links for CDM, dsbulk migrator, and dsbulk as well? Create one release notes section at the end of the nav?
...
//TODO: Move to planning or intro

include::partial$supported-releases.adoc[]

== Migration scenarios

//TODO: Create a Migration paths page or section in the Planning phase.
