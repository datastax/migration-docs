...
If your clusters are incompatible, you might be able to use data migration tools such as xref:ROOT:dsbulk-migrator-overivew.adoc[{dsbulk-migrator}] or a custom data migration script.
