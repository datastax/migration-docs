...
<div class="grid gap-6 lg:grid-cols-4">
  <div class="flex flex-col gap-4">
    ...
    <h3 class="discrete !text-h2 !m-0">{zdm-proxy}</h3>

    <p>To support live migrations, {zdm-proxy} orchestrates activity-in-transition on your clusters, allowing your applications to run while you migrate data.</p>
  ...
  <div class="flex flex-col gap-4">
    ...
    <h3 class="discrete !text-h2 !m-0">{cass-migrator}</h3>
  ...
  <div class="flex flex-col gap-4">
    ...
    <h3 class="discrete !text-h2 !m-0">{dsbulk}</h3>

    <p>{dsbulk-short} can load, unload, and count large volumes of data from your {cass-short}-based clusters.</p>

    <div class="landing-a mt-auto">
        xref:dsbulk:overview:dsbulk-about.adoc[Get started with {dsbulk-short}]
    </div>
