...
[IMPORTANT]
====
* True zero downtime migration is only possible if your database meets the minimum xref:ROOT:feasibility-checklists.adoc[requirements].
...
Your migration project occurs through a sequence of phases, including preparation and five migration phases.
