...
// {dsbulk-migrator} repo's https://github.com/datastax/dsbulk-migrator/blob/main/README.md[README, window="_blank"]. 

[[cdm-tasks]]
== Cassandra Data Migrator tasks

TODO - adding this entire detailed section next...


[[dsbulk-migrator-tasks]]
== {dsbulk-migrator} tasks

To use {dsbulk-migrator}:
