...
You will also need to check whether the driver used by your client application has native support for the https://docs.datastax.com/en/astra-serverless/docs/migrate/glossary.html#_secure_connect_bundle_scb[Astra DB Secure Connect Bundle (SCB)^]. To do so, please refer to the documentation for your driver language and version.
