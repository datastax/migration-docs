...
To apply this change, run the `rolling_update_zdm_proxy.yml` playbook as explained xref:manage-proxy-instances.adoc#_change_a_mutable_configuration_variable[here].
