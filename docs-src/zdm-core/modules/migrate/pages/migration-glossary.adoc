...
A ZIP file generated in https://astra.datastax.com[Astra Portal^] contains connection metadata and TLS encryption certificates for your Astra DB database. For details, see https://docs.datastax.com/en/astra-serverless/docs/connect/secure-connect-bundle.html[Working with the secure connect bundle^].
