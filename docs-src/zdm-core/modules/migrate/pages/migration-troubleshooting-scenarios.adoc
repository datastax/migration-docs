...
2. The Astra database is hibernated/suspended.

=== Workaround

Start by opening Astra Portal and checking the `Status` of your database. If it is `Active`, then it is likely an issue with permissions.
