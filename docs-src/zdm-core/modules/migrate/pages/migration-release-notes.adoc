...
For code updates and additions, see the {zdm-proxy} 2.0 https://github.com/datastax/zdm-proxy/blob/main/CHANGELOG/CHANGELOG-2.0.md[CHANGELOG^] in the {zdm-proxy} open-source GitHub repo.
