...
To get acquainted with the migration phases from start to finish, click the **Start** button below the diagram. Additional navigation options are available on subsequent diagrams, allowing you to control the navigation as you discover the key concepts, software components, and sequence of operations.
