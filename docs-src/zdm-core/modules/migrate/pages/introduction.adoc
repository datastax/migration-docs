...
image:zdm-migration-all.png[Migration phases from start to finish]
...
image:zdm-migration-phase2.png[Phase 2 diagram shows using tools to migrate data from Origin to Target.]
...
image:zdm-migration-phase4.png[Phase 4 diagram shows read routing on ZDM Proxy was switched to Target.]
...
image:zdm-migration-phase5.png[Phase 5 diagram shows apps no longer using proxy and instead connected directly to Target.]
