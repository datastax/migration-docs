...
This interactive resource spans the pre-migration prerequisites and each of the five key migration phases. 

For an introduction to the terms and illustrated phases, see the next section.
...
Your migration project can occur through a sequence of phases, with zero downtime, as illustrated above.
