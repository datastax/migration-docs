...
image::pre-migration0ra9.png["A pre-migration high-level diagram. Your client applications perform read/write operations with an existing CQL-compatible database: Apache Cassandra, DSE, or Astra DB."]
--
