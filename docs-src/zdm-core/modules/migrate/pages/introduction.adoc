...
image::{imagesprefix}zdm-migration-phase4.png[Phase 4 diagram shows read routing on ZDM Proxy was switched to Target.]
...
image::{imagesprefix}zdm-migration-phase5.png[Phase 5 diagram shows apps no longer using proxy and instead connected directly to Target.]
