...
[TIP]
====
To get acquainted with the migration phases, begin by clicking the **Start** button below the diagram.
You can optionally click the illustrated components to open a larger view. 
Click again to return to the original view and use the navigation buttons. 
====
