...
Learn how to xref:migration-run-ansible-playbooks.adoc[configure Ansible] by setting just a few variables for your environment. Once configured, Ansible will run a playbook that deploys the {zdm-proxy} on your servers.
