= Setup and run Ansible playbooks to deploy {zdm-proxy} and Monitoring

This topic explains how to use the {zdm-automation} to create a dedicated deployment of the {zdm-proxy} and its companion monitoring stack.

We will see how to configure the machine from which the {zdm-automation} automation is run, and then how to execute the automation. At the end, you will have a working and fully monitored {zdm-proxy} deployment.
